...
$link = new moodle_url('http://localhost/moodle/enrol/importexcel/index.php', array('id' => $cid));
echo html_writer::link($link, 'Upload file excel', array('class' => 'btn btn-primary', 'id' => 'excel'));
