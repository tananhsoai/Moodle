...
$link = new moodle_url('http://localhost/moodle/course/report/diemkt/index.php', array('id' => $courseid));
echo html_writer::link($link, 'Xem Bảng Điểm', array('class' => 'excel', 'id' => 'your-id'));
...
echo '<style>
    ...
    .excel:hover { background-color: #3399FF; }
</style>';
